        ...
        >
          ...
          <Grid container item xs={10} zIndex={2} gap={4} p={4}>
            ...
            <Grid xs={12}>
              ...
              >
                {dictionaryContent.loginPage.welcomeMessage.title}
                <span style={{ color: "#96C11F" }}>
                  {" "}
                  {dictionaryContent.loginPage.welcomeMessage.bankTitle}
                </span>{" "}
                {dictionaryContent.loginPage.welcomeMessage.bankName}
                <span style={{ color: "#96C11F" }}>
                  {" "}
                  {dictionaryContent.loginPage.welcomeMessage.CorporateLabel}
                </span>{" "}
                {dictionaryContent.loginPage.welcomeMessage.internetBanking}
              </Typography>
            </Grid>
            <Grid xs={12}>
